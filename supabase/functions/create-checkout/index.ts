...
const TREATMENTS: Record<string, { name: string; durationMinutes: number; pricePence: number }> = {
  ...
  "swedish-60":  { name: "Swedish Massage (60 min)",              durationMinutes: 60, pricePence: 5500 },
  "swedish-75":  { name: "Swedish Massage (75 min)",              durationMinutes: 75, pricePence: 7000 },
  "bespoke-30":  { name: "Bespoke Restorative Massage (30 min)",  durationMinutes: 30, pricePence: 4000 },
  "bespoke-45":  { name: "Bespoke Restorative Massage (45 min)",  durationMinutes: 45, pricePence: 5500 },
